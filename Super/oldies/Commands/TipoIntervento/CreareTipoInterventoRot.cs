...
{
    public class CreareTipoInterventoRot : CommandBase
    {
        ...
        public CreareTipoInterventoRot()
        {
        }

        public CreareTipoInterventoRot(Guid id, int idTipoInterventoRotSuper, DateTime inizio, DateTime? fine, string descrizione, DateTime creationDate)
        {
            this.Id = id;
