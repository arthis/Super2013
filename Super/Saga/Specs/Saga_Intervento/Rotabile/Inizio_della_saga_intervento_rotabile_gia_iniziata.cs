...
{
    public class Inizio_della_saga_intervento_rotabile_gia_iniziata : SagaBaseClass<InterventoRotGenerated>
    {
        ...
        {
            yield return new InterventoRotGenerated()
            {
                Period = _period,
                Id = _id,
        ...
        {
            return  new InterventoRotGenerated()
            {
                Period = _period,
                Id = _id,
                IdImpianto = _idImpianto,
