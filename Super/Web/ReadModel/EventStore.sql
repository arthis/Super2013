...
/****** Object:  Database [Super2013.Administration.EventStore]    Script Date: 06/21/2012 09:01:25 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'Super2013.Administration.EventStore')
DROP DATABASE [Super2013.Administration.EventStore]
GO
...
/****** Object:  Database [Super2013.Administration.EventStore]    Script Date: 06/21/2012 09:01:25 ******/
CREATE DATABASE [Super2013.Administration.EventStore] ON  PRIMARY 
( NAME = N'Super2013.Administration.EventStore', FILENAME = N'D:\Databases\Super2013.Administration.EventStore.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Super2013.Administration.EventStore_log', FILENAME = N'D:\Databases\Super2013.Administration.EventStore_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET COMPATIBILITY_LEVEL = 100
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Super2013.Administration.EventStore].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET ARITHABORT OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET AUTO_CREATE_STATISTICS ON 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET  DISABLE_BROKER 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET  READ_WRITE 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET RECOVERY FULL 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET  MULTI_USER 
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [Super2013.Administration.EventStore] SET DB_CHAINING OFF 
GO
