...
{
    public class CreareTipoInterventoAmb : CommandBase
    {
        ...
        public CreareTipoInterventoAmb()
        {
        }

        public CreareTipoInterventoAmb(Guid id, int idTipoInterventoAmbSuper, DateTime inizio, DateTime? fine, string descrizione, DateTime creationDate)
        {
            this.Id = id;
