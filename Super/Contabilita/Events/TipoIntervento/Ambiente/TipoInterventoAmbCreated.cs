...
namespace Super.Contabilita.Events.TipoIntervento.Ambiente
{
    ...
    public class TipoInterventoAmbCreated : CommandBase
    {
        ...
        public TipoInterventoAmbCreated()
        {
            
        }

        public TipoInterventoAmbCreated(Guid id, Guid commitId, long version, string mnemo, Guid idMeasuringUnit, string description)
        ...
        {
            return string.Format("Il tipo intervento ambiente é stato creato '{0}'.", Description);
        }

        public bool Equals(TipoInterventoAmbCreated other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as TipoInterventoAmbCreated);
        }
    ...
    class TipoInterventoAmbCreatedImpl : TipoInterventoAmbCreated
    {
    }
}
