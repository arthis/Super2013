...
namespace Super.Contabilita.Events.TipoIntervento.Rotabile
{
    ...
    public class TipoInterventoRotCreated : Message, IEvent
    {
        ...
        public TipoInterventoRotCreated()
        {
            
        }

        public TipoInterventoRotCreated(Guid id, Guid commitId, long version, string mnemo, Guid idMeasuringUnit, char classe, bool calcoloDetrazioni, bool aiTreni, string description)
        ...
        {
            return string.Format("Il tipo intervento rotabile  é stato creato'{0}'.", Description);
        }

        public bool Equals(TipoInterventoRotCreated other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as TipoInterventoRotCreated);
        }
