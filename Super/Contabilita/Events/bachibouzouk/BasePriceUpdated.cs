...
namespace Super.Contabilita.Events.Pricing
{
    public class BasePriceUpdated: Message,IEvent
    {
        ...
        public BasePriceUpdated(Guid id, Guid commitId, long version, Guid idBasePrice, decimal value, IntervalOpened interval, Guid idTipoIntervento, Guid idGruppoOggettoInervento)
