...
{
    public class CarriageRotManUpdatedBuilder : ICommandBuilder<CarriageRotManUpdated>
    {
        ...
        {
            var cmd = new CarriageRotManUpdated(id, commitId, version, _sign, _description, _isInternational);
            return cmd;
        }
