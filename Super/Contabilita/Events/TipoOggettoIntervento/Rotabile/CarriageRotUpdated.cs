...
namespace Super.Contabilita.Events.TipoOggettoIntervento.Rotabile
{
    ...
    public class CarriageRotUpdated : Message, IEvent
    {
        ...
        public CarriageRotUpdated(Guid id, Guid commitId, long version, string sign, string description, bool isInternational)
