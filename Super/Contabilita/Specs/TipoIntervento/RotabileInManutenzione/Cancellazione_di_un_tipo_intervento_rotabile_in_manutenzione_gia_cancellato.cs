...
{
    public class Cancellazione_di_un_tipo_intervento_rotabile_in_manutenzione_gia_cancellato : CommandBaseClass<DeleteTipoInterventoRotMan>
    {
        ...
        {
            return Commands.Builders.Build.DeleteTipoInterventoRotMan
                .Build(_id, 2);
        }
