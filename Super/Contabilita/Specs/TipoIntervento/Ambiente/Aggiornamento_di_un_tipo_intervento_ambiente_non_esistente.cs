...
{
    public class Aggiornamento_di_un_tipo_intervento_ambiente_non_esistente : CommandBaseClass<UpdateTipoInterventoAmb>
    {
        ...
        public override UpdateTipoInterventoAmb When()
        {
            ...
            return  BuildCmd.UpdateTipoInterventoAmb
