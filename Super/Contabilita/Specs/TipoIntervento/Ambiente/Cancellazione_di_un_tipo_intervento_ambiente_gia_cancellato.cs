...
{
    public class Cancellazione_di_un_tipo_intervento_ambiente_gia_cancellato : CommandBaseClass<DeleteTipoInterventoAmb>
    {
        ...
        {
            return Commands.Builders.Build.DeleteTipoInterventoAmb
                .Build(_id, 2);
        }
