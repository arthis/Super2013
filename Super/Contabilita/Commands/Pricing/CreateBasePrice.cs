...
namespace Super.Contabilita.Commands.Pricing
{
    public class CreateBasePrice : CommandBase
    {
        ...
        public CreateBasePrice(Guid id, Guid commitId, long version, Guid idBasePrice, decimal value, IntervalOpened interval, Guid idTipoIntervento, Guid idGruppoOggettoInervento)
