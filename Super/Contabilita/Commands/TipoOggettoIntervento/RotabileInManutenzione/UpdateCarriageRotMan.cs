...
namespace Super.Contabilita.Commands.TipoOggettoIntervento.RotabileInManutenzione
{
    ...
    public class UpdateCarriageRotMan : CommandBase
    {
        ...
        public UpdateCarriageRotMan()
        {}

        public UpdateCarriageRotMan(Guid id, Guid commitId, long version, string sign, string description, bool isInternational, Guid idGruppoOggettoIntervento)
        ...
        {
            return string.Format("Aggiorniamo la carrozza rotabile in manutenzione '{0}')", Description);
        }

        public bool Equals(UpdateCarriageRotMan other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateCarriageRotMan);
        }
