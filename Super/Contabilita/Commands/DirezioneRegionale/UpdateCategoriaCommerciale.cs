...
namespace Super.Contabilita.Commands.DirezioneRegionale
{
    ...
    public class UpdateDirezioneRegionale : CommandBase
    {
        ...
        public UpdateDirezioneRegionale(Guid id, Guid commitId, long version, string description, string sign)
        ...
        {
            return string.Format("Aggiorniamo il direzione regionale '{0}')", Description);
        }
