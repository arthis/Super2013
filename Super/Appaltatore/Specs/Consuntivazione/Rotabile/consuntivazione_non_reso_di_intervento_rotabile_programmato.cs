...
{
    public class consuntivazione_non_reso_di_intervento_rotabile_programmato : CommandBaseClass<ConsuntivareNonResoInterventoRot>
    {
        //programmato
        ...
        protected override CommandHandler<ConsuntivareNonResoInterventoRot> OnHandle(IEventRepository eventRepository)
        {
            return new ConsuntivareNonResoInterventoRotHandler(eventRepository);
        }
        ...
        public override ConsuntivareNonResoInterventoRot When()
        {
            return BuildCmd.ConsuntivareNonResoInterventoRot
