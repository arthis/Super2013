...
{
    public class consuntivazione_automatica_non_reso_di_intervento_rotabile_gia_consuntivato : CommandBaseClass<ConsuntivareAutomaticamenteNonResoInterventoRot>
    {
        //programmato
