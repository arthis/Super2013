...
namespace Super.Programmazione.Events.Scenario
{
    ...
    public abstract class SchedulationAddedToScenario : Message , IEvent
    {
        ...
        public SchedulationAddedToScenario()
        {

        }

        public SchedulationAddedToScenario(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(SchedulationAddedToScenario other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as SchedulationAddedToScenario);
        }
    ...
    public class SchedulationRotAddedToScenario : SchedulationAddedToScenario
    {
        ...
        public SchedulationRotAddedToScenario()
        {
            
        }

        public SchedulationRotAddedToScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idScenario,
        ...
        public bool Equals(SchedulationRotAddedToScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotAddedToScenario);
        }
    ...
    public class SchedulationRotManAddedToScenario : SchedulationAddedToScenario
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public SchedulationRotManAddedToScenario()
        {

        }

        public SchedulationRotManAddedToScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idScenario,
        ...
        public bool Equals(SchedulationRotManAddedToScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotManAddedToScenario);
        }
    ...
    public class SchedulationAmbAddedToScenario : SchedulationAddedToScenario
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public SchedulationAmbAddedToScenario()
        {

        }

        public SchedulationAmbAddedToScenario(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idScenario,
        ...
        public bool Equals(SchedulationAmbAddedToScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationAmbAddedToScenario);
        }
