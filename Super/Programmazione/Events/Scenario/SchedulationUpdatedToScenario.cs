...
{
    public abstract class SchedulationUpdatedToScenario : Message , IEvent
    {
        ...
        public SchedulationUpdatedToScenario()
        {

        }

        public SchedulationUpdatedToScenario(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(SchedulationUpdatedToScenario other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as SchedulationUpdatedToScenario);
        }
    ...
    public class SchedulationRotUpdatedOfScenario : SchedulationUpdatedToScenario
    {
        ...
        public SchedulationRotUpdatedOfScenario()
        {

        }

        public SchedulationRotUpdatedOfScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idScenario,
        ...
        public bool Equals(SchedulationRotUpdatedOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotUpdatedOfScenario);
        }
    ...
    public class SchedulationRotManUpdatedOfScenario : SchedulationUpdatedToScenario
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public SchedulationRotManUpdatedOfScenario()
        {

        }

        public SchedulationRotManUpdatedOfScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idScenario,
        ...
        public bool Equals(SchedulationRotManUpdatedOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotManUpdatedOfScenario);
        }
    ...
    public class SchedulationAmbUpdatedOfScenario : SchedulationUpdatedToScenario
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public SchedulationAmbUpdatedOfScenario()
        {

        }

        public SchedulationAmbUpdatedOfScenario(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idScenario,
        ...
        public bool Equals(SchedulationAmbUpdatedOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationAmbUpdatedOfScenario);
        }
