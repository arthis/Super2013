...
{
    public abstract class InterventoScheduled : Message, IEvent, IInterventoScheduled
    {
        ...
        public InterventoScheduled()
        {
            
        }

        public InterventoScheduled(Guid id,
            Guid commitId,
            long version,
        ...
        public bool Equals(InterventoScheduled other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as InterventoScheduled);
        }
    ...
    public class InterventoRotScheduled : InterventoScheduled
    {
        public InterventoRotScheduled()
        {

        }

        public InterventoRotScheduled(Guid id, Guid commitId, long version, Guid idPeriodoProgrammazione,
            ...
            : base(id, commitId, version, idPeriodoProgrammazione, idProgramm, idSchedulazione,idInterventoGeneration, idCommittente, idLotto, idImpianto, idTipoIntervento, idAppaltatore, idCategoriaCommerciale, idDirezioneRegionale, period, note)
        {
        ...
        public bool Equals(InterventoRotScheduled other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as InterventoRotScheduled);
        }
    ...
    public class InterventoRotManScheduled : InterventoScheduled
    {
        public InterventoRotManScheduled()
        {

        }

        public InterventoRotManScheduled(Guid id, Guid commitId, long version, Guid idPeriodoProgrammazione,
                                   Guid idProgramm, Guid idSchedulazione, Guid idInterventoGeneration,
                                   Guid idCommittente,
        ...
        public bool Equals(InterventoRotManScheduled other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as InterventoRotManScheduled);
        }
    ...
    public class InterventoAmbScheduled : InterventoScheduled
    {
        public InterventoAmbScheduled()
        {

        }

        public InterventoAmbScheduled(Guid id, Guid commitId, long version, Guid idPeriodoProgrammazione,
                                   Guid idProgramm, Guid idSchedulazione, Guid idInterventoGeneration,
                                   Guid idCommittente,
        ...
        public override string ToDescription()
        {
            return string.Format("Il Intervento ambiente {0} é stato schedulato.", Id);
        }

        public bool Equals(InterventoAmbScheduled other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as InterventoAmbScheduled);
        }
