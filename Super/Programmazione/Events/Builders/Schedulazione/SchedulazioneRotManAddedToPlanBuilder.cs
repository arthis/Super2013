...
{
    public class SchedulazioneRotManAddedToPlanBuilder : ICommandBuilder<SchedulazioneRotManAddedToPlan>
    {
        ...
        public SchedulazioneRotManAddedToPlanBuilder ForPeriod(WorkPeriod workPeriod)
        {
