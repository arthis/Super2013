...
{
    public class SchedulazioneRotManAddedToScenarioBuilder : ICommandBuilder<SchedulazioneRotManAddedToScenario>
    {
        ...
        public SchedulazioneRotManAddedToScenarioBuilder ForPeriod(WorkPeriod workPeriod)
        {
