...
{
    public abstract class SchedulationUpdatedOfPlan : CommandBase
    {
        ...
        public SchedulationUpdatedOfPlan()
        {

        }

        public SchedulationUpdatedOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(SchedulationUpdatedOfPlan other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as SchedulationUpdatedOfPlan);
        }
    ...
    public class SchedulationRotUpdatedOfPlan : SchedulationUpdatedOfPlan
    {
        ...
        public SchedulationRotUpdatedOfPlan()
        {

        }

        public SchedulationRotUpdatedOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(SchedulationRotUpdatedOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotUpdatedOfPlan);
        }
    ...
    public class SchedulationRotManUpdatedOfPlan : SchedulationUpdatedOfPlan
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public SchedulationRotManUpdatedOfPlan()
        {

        }

        public SchedulationRotManUpdatedOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(SchedulationRotManUpdatedOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotManUpdatedOfPlan);
        }
    ...
    public class SchedulationAmbUpdatedOfPlan : SchedulationUpdatedOfPlan
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public SchedulationAmbUpdatedOfPlan()
        {

        }

        public SchedulationAmbUpdatedOfPlan(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idPlan,
        ...
        public bool Equals(SchedulationAmbUpdatedOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationAmbUpdatedOfPlan);
        }
