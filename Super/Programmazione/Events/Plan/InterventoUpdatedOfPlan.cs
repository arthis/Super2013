...
namespace Super.Programmazione.Events.Plan
{
    public abstract class InterventoUpdatedOfPlan : CommandBase
    {
        ...
        public InterventoUpdatedOfPlan()
        {

        }

        public InterventoUpdatedOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(InterventoUpdatedOfPlan other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as InterventoUpdatedOfPlan);
        }
    ...
    public class InterventoRotUpdatedOfPlan : InterventoUpdatedOfPlan
    {
        ...
        public InterventoRotUpdatedOfPlan()
        {

        }

        public InterventoRotUpdatedOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        {
            return string.Format("Schedulazione  rotabile {0} é stata aggiornata al piano", Id);
        }

        public bool Equals(InterventoRotUpdatedOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as InterventoRotUpdatedOfPlan);
        }
    ...
    public class InterventoRotManUpdatedOfPlan : InterventoUpdatedOfPlan
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public InterventoRotManUpdatedOfPlan()
        {

        }

        public InterventoRotManUpdatedOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public override string ToDescription()
        {
            return string.Format("Schedulazione  rotabile in manutenzione {0} é stata aggionata  al piano ", Id);
        }

        public bool Equals(InterventoRotManUpdatedOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as InterventoRotManUpdatedOfPlan);
        }
    ...
    public class InterventoAmbUpdatedOfPlan : InterventoUpdatedOfPlan
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public InterventoAmbUpdatedOfPlan()
        {

        }

        public InterventoAmbUpdatedOfPlan(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idPlan,
        ...
        public override string ToDescription()
        {
            return string.Format("Schedulazione  ambiente {0} é stata aggionata  al piano ", Id);
        }

        public bool Equals(InterventoAmbUpdatedOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as InterventoAmbUpdatedOfPlan);
        }
