...
{
    public abstract class SchedulationAddedToPlan : Message, IEvent
    {
        ...
        public SchedulationAddedToPlan()
        {

        }

        public SchedulationAddedToPlan(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(SchedulationAddedToPlan other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as SchedulationAddedToPlan);
        }
    ...
    public class SchedulationRotAddedToPlan : SchedulationAddedToPlan
    {
        ...
        public SchedulationRotAddedToPlan()
        {

        }

        public SchedulationRotAddedToPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(SchedulationRotAddedToPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotAddedToPlan);
        }
    ...
    public class SchedulationRotManAddedToPlan : SchedulationAddedToPlan
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public SchedulationRotManAddedToPlan()
        {

        }

        public SchedulationRotManAddedToPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(SchedulationRotManAddedToPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationRotManAddedToPlan);
        }
    ...
    public class SchedulationAmbAddedToPlan : SchedulationAddedToPlan
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public SchedulationAmbAddedToPlan()
        {

        }

        public SchedulationAmbAddedToPlan(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idPlan,
        ...
        public bool Equals(SchedulationAmbAddedToPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as SchedulationAmbAddedToPlan);
        }
