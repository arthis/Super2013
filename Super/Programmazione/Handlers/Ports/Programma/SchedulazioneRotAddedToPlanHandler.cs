...
namespace Super.Programmazione.Handlers.Ports.Programma
{
    ...
    public class SchedulazioneRotAddedToPlanHandler : 
        IPortHandler<SchedulazioneRotAddedToPlan, AddSchedulazioneRotToProgramma>
    {
        public AddSchedulazioneRotToProgramma Port(SchedulazioneRotAddedToPlan evt)
        {
