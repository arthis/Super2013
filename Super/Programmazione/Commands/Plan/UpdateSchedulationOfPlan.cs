...
{
    public abstract class UpdateSchedulationOfPlan : CommandBase
    {
        ...
        public UpdateSchedulationOfPlan()
        {

        }

        public UpdateSchedulationOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(UpdateSchedulationOfPlan other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateSchedulationOfPlan);
        }
    ...
    public class UpdateSchedulationRotOfPlan : UpdateSchedulationOfPlan
    {
        ...
        public UpdateSchedulationRotOfPlan()
        {

        }

        public UpdateSchedulationRotOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(UpdateSchedulationRotOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulationRotOfPlan);
        }
    ...
    public class UpdateSchedulationRotManOfPlan : UpdateSchedulationOfPlan
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public UpdateSchedulationRotManOfPlan()
        {

        }

        public UpdateSchedulationRotManOfPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(UpdateSchedulationRotManOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulationRotManOfPlan);
        }
    ...
    public class UpdateSchedulationAmbOfPlan : UpdateSchedulationOfPlan
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public UpdateSchedulationAmbOfPlan()
        {

        }

        public UpdateSchedulationAmbOfPlan(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idPlan,
        ...
        public bool Equals(UpdateSchedulationAmbOfPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulationAmbOfPlan);
        }
