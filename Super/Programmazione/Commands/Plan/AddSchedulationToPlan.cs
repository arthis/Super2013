...
{
    public abstract class AddSchedulationToPlan : CommandBase
    {
    ...
    public class AddSchedulationRotToPlan : AddSchedulationToPlan
    {
        ...
        public AddSchedulationRotToPlan()
        {

        }

        public AddSchedulationRotToPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        {
            return string.Format("Aggiungere una schedulazione  rotabile {0}  al plan ", Id);
        }

        public bool Equals(AddSchedulationRotToPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as AddSchedulationRotToPlan);
        }
    ...
    public class AddSchedulationRotManToPlan : AddSchedulationToPlan
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public AddSchedulationRotManToPlan()
        {

        }

        public AddSchedulationRotManToPlan(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idPlan,
        ...
        public bool Equals(AddSchedulationRotManToPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as AddSchedulationRotManToPlan);
        }
    ...
    public class AddSchedulationAmbToPlan : AddSchedulationToPlan
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public AddSchedulationAmbToPlan()
        {

        }

        public AddSchedulationAmbToPlan(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idPlan,
        ...
        public bool Equals(AddSchedulationAmbToPlan other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as AddSchedulationAmbToPlan);
        }
