...
{
    public abstract class UpdateSchedulationToScenario : CommandBase
    {
        ...
        public UpdateSchedulationToScenario()
        {

        }

        public UpdateSchedulationToScenario(Guid id,
                                   Guid commitId,
                                   long version,
        ...
        public bool Equals(UpdateSchedulationToScenario other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateSchedulationToScenario);
        }
    ...
    public class UpdateSchedulationRotOfScenario : UpdateSchedulationToScenario
    {
        ...
        public UpdateSchedulationRotOfScenario()
        {

        }

        public UpdateSchedulationRotOfScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idScenario,
        ...
        public bool Equals(UpdateSchedulationRotOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulationRotOfScenario);
        }
    ...
    public class UpdateSchedulationRotManOfScenario : UpdateSchedulationToScenario
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public UpdateSchedulationRotManOfScenario()
        {

        }

        public UpdateSchedulationRotManOfScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idPeriodoProgrammazione,
                                   Guid idScenario,
        ...
        public bool Equals(UpdateSchedulationRotManOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulationRotManOfScenario);
        }
    ...
    public class UpdateSchedulationAmbOfScenario : UpdateSchedulationToScenario
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public UpdateSchedulationAmbOfScenario()
        {

        }

        public UpdateSchedulationAmbOfScenario(Guid id,
                                               Guid commitId,
                                               long version,
                                               Guid idPeriodoProgrammazione,
                                               Guid idScenario,
        ...
        public bool Equals(UpdateSchedulationAmbOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulationAmbOfScenario);
        }
