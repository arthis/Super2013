...
{
    public class UpdateSchedulationOfScenario : CommandBase
    {
        ...
        public UpdateSchedulationOfScenario()
        {

        }

        public UpdateSchedulationOfScenario(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idImpianto,
        ...
        {
            return string.Format("Aggiornare schedulazione {0} al scenario ", Id);
        }

        public bool Equals(UpdateSchedulationOfScenario other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateSchedulationOfScenario);
        }
