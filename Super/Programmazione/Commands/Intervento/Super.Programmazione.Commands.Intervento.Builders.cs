...
namespace Super.Programmazione.Commands.Plan.Builders
{
	...
	public class CreateInterventoRotBuilder : ICommandBuilder<CreateInterventoRot>
	{
		...
		public CreateInterventoRot Build(Guid id)
		{
			return Build(id, Guid.NewGuid());
		}

		public CreateInterventoRot Build(Guid id, Guid commitId)
        {
            return new CreateInterventoRot(id, commitId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _convoglio, _rigaTurnoTreno, _turnoTreno, _trenoArrivo, _trenoPartenza, _oggetti);
		 }
		...
		public CreateInterventoRot Build(Guid id, Guid commitId, Guid userId)
        {
            return new CreateInterventoRot(id, commitId, userId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _convoglio, _rigaTurnoTreno, _turnoTreno, _trenoArrivo, _trenoPartenza, _oggetti);
		 }

		 public CreateInterventoRot Build(Guid id, long version, Guid userId)
		{
			return Build(id, Guid.NewGuid(), version, userId);
		}

		public CreateInterventoRot Build(Guid id, Guid commitId, long version, Guid userId)
        {
            return new CreateInterventoRot(id, commitId, version, userId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _convoglio, _rigaTurnoTreno, _turnoTreno, _trenoArrivo, _trenoPartenza, _oggetti);
		}

		public CreateInterventoRot Build(Guid id, DateTime wakeupTime)
		{
			return Build(id, Guid.NewGuid(), wakeupTime);
		}

		public CreateInterventoRot Build(Guid id, Guid commitId, DateTime wakeupTime)
        {
		...
		public CreateInterventoRot Build(Guid id, Guid commitId, long version, DateTime wakeupTime)
        {
            return new CreateInterventoRot(id, commitId, version, wakeupTime, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _convoglio, _rigaTurnoTreno, _turnoTreno, _trenoArrivo, _trenoPartenza, _oggetti);
		 }
	...
	public class CreateInterventoRotManBuilder : ICommandBuilder<CreateInterventoRotMan>
	{
		...
		public CreateInterventoRotMan Build(Guid id)
		{
			return Build(id, Guid.NewGuid());
		}

		public CreateInterventoRotMan Build(Guid id, Guid commitId)
        {
            return new CreateInterventoRotMan(id, commitId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _oggetti);
		 }
		...
		public CreateInterventoRotMan Build(Guid id, Guid commitId, Guid userId)
        {
            return new CreateInterventoRotMan(id, commitId, userId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _oggetti);
		 }

		 public CreateInterventoRotMan Build(Guid id, long version, Guid userId)
		{
			return Build(id, Guid.NewGuid(), version, userId);
		}

		public CreateInterventoRotMan Build(Guid id, Guid commitId, long version, Guid userId)
        {
            return new CreateInterventoRotMan(id, commitId, version, userId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _oggetti);
		}

		public CreateInterventoRotMan Build(Guid id, DateTime wakeupTime)
		{
			return Build(id, Guid.NewGuid(), wakeupTime);
		}

		public CreateInterventoRotMan Build(Guid id, Guid commitId, DateTime wakeupTime)
        {
		...
		public CreateInterventoRotMan Build(Guid id, Guid commitId, long version, DateTime wakeupTime)
        {
            return new CreateInterventoRotMan(id, commitId, version, wakeupTime, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _oggetti);
		 }
	...
	public class CreateInterventoAmbBuilder : ICommandBuilder<CreateInterventoAmb>
	{
		...
		public CreateInterventoAmb Build(Guid id)
		{
			return Build(id, Guid.NewGuid());
		}

		public CreateInterventoAmb Build(Guid id, Guid commitId)
        {
            return new CreateInterventoAmb(id, commitId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _quantity, _description);
		 }
		...
		public CreateInterventoAmb Build(Guid id, Guid commitId, Guid userId)
        {
            return new CreateInterventoAmb(id, commitId, userId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _quantity, _description);
		 }

		 public CreateInterventoAmb Build(Guid id, long version, Guid userId)
		{
			return Build(id, Guid.NewGuid(), version, userId);
		}

		public CreateInterventoAmb Build(Guid id, Guid commitId, long version, Guid userId)
        {
            return new CreateInterventoAmb(id, commitId, version, userId, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _quantity, _description);
		}

		public CreateInterventoAmb Build(Guid id, DateTime wakeupTime)
		{
			return Build(id, Guid.NewGuid(), wakeupTime);
		}

		public CreateInterventoAmb Build(Guid id, Guid commitId, DateTime wakeupTime)
        {
		...
		public CreateInterventoAmb Build(Guid id, Guid commitId, long version, DateTime wakeupTime)
        {
            return new CreateInterventoAmb(id, commitId, version, wakeupTime, _idProgramma, _idPeriodoProgrammazione, _idCommittente, _idLotto, _idImpianto, _idTipoIntervento, _idAppaltatore, _idCategoriaCommerciale, _idDirezioneRegionale, _note, _workPeriod, _quantity, _description);
		 }
