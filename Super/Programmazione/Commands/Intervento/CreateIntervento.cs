...
{
    public class CreateIntervento : CommandBase
    {
        ...
        public CreateIntervento()
        {
            
        }

        public CreateIntervento(Guid id,
                                   Guid commitId,
                                   long version,
                                   Guid idImpianto,
        ...
        public bool Equals(CreateIntervento other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as CreateIntervento);
        }
