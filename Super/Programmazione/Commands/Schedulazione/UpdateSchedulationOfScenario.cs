...
{
    public abstract class UpdateSchedulazioneToScenario : CommandBase
    {
        ...
        public UpdateSchedulazioneToScenario()
        {

        }

        public UpdateSchedulazioneToScenario(Guid id,
            Guid commitId,
            long version,
        ...
        protected bool Equals(UpdateSchedulazioneToScenario other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((UpdateSchedulazioneToScenario) obj);
        }
    ...
    public class UpdateSchedulazioneRotOfScenario : UpdateSchedulazioneToScenario
    {
        ...
        public UpdateSchedulazioneRotOfScenario()
        {

        }

        public UpdateSchedulazioneRotOfScenario(Guid id,
            Guid commitId,
            long version,
            Guid idPeriodoProgrammazione,
            Guid idScenario,
        ...
        public bool Equals(UpdateSchedulazioneRotOfScenario other)
        {
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulazioneRotOfScenario);
        }
    ...
    public class UpdateSchedulazioneRotManOfScenario : UpdateSchedulazioneToScenario
    {

        public OggettoRotMan[] Oggetti { get; set; }

        public UpdateSchedulazioneRotManOfScenario()
        {

        }

        public UpdateSchedulazioneRotManOfScenario(Guid id,
            Guid commitId,
            long version,
            Guid idPeriodoProgrammazione,
            Guid idScenario,
        ...
        public bool Equals(UpdateSchedulazioneRotManOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulazioneRotManOfScenario);
        }
    ...
    public class UpdateSchedulazioneAmbOfScenario : UpdateSchedulazioneToScenario
    {

        public string Description { get; set; }
        public int Quantity { get; set; }

        public UpdateSchedulazioneAmbOfScenario()
        {

        }

        public UpdateSchedulazioneAmbOfScenario(Guid id,
            Guid commitId,
            long version,
            Guid idPeriodoProgrammazione,
            Guid idScenario,
        ...
        public bool Equals(UpdateSchedulazioneAmbOfScenario other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            return Equals(obj as UpdateSchedulazioneAmbOfScenario);
        }
