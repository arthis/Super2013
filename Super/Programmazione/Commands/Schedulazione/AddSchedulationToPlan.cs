...
{
    public abstract class AddSchedulazioneToPlan : CommandBase
    {
        ...
        public AddSchedulazioneToPlan()
        {

        }

        public AddSchedulazioneToPlan(Guid id,
            Guid commitId,
            long version,
        ...
        public bool Equals(AddSchedulazioneToPlan other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as AddSchedulazioneToPlan);
        }
    ...
    public class AddSchedulazioneRotToPlan : AddSchedulazioneToPlan
    {
        ...
        public AddSchedulazioneRotToPlan(Guid id,
            Guid commitId,
            long version,
            Guid idPeriodoProgrammazione,
            Guid idPlan,
    ...
    public class AddSchedulazioneRotManToPlan : AddSchedulazioneToPlan
    {
        ...
        public AddSchedulazioneRotManToPlan(Guid id,
            Guid commitId,
            long version,
            Guid idPeriodoProgrammazione,
            Guid idPlan,
    ...
    public class AddSchedulazioneAmbToPlan : AddSchedulazioneToPlan
    {
        ...
        public AddSchedulazioneAmbToPlan(Guid id,
            Guid commitId,
            long version,
            Guid idPeriodoProgrammazione,
            Guid idPlan,
