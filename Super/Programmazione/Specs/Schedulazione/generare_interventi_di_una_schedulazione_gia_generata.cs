...
{
    public class generare_interventi_di_una_schedulazione_gia_generata : CommandBaseClass<AskToGenerateInterventi>
    {
        ...
        public void genera_un_eccezzione()
        {
            ...
            Assert.AreEqual(typeof(SchedulazionealreadyGeneratedException), Caught.GetType());
        }
