...
{
    public class confirmare_il_fallimento_della_generazione_degli_interventi_di_una_schedulazione : CommandBaseClass<ConfirmGenerationFailed>
    {
        ...
        protected override CommandHandler<ConfirmGenerationFailed> OnHandle(IEventRepository eventRepository)
        {
            return new ConfirmGenerationFailedHandler(eventRepository);
        }
        ...
        public override ConfirmGenerationFailed When()
        {
            return BuildCmd.ConfirmGenerationFailed
                .Build(_id, 2);
        }
