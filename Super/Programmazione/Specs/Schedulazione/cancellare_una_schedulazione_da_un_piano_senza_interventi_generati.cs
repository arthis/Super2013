...
{
    public class cancellare_una_schedulazione_da_un_piano_senza_interventi_generati : CommandBaseClass<CancelSchedulazioneFromPlan>
    {
        ...
        {
            yield return BuildEvt.SchedulazioneCancelledFromPlan
                .ByUser(_idUserCancelling)
                .ForAllGeneratedInterventi(_deleteGeneratedInterventi)
                .Build(_id, 2);
        }
