...
namespace Cqrs
{
    /// <summary>The Cqrs environment. This class gives access to other components registered in this environment.
    /// <remarks>
    /// Make sure to call the <see cref="Configure"/> method before doing anything else with this class.
    /// </remarks></summary>
    public static class CqrsEnvironment
    {
        private static readonly ILog Log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        static CqrsEnvironment()
        {
            InitDefaults();
        }
        ...
        private static void InitDefaults()
        {
            ...
            SetDefault<IKnownCommandsEnumerator>(new AllCommandsInAppDomainEnumerator()); // to take off commandBase later
        ...
        /// <summary>
        /// Configures the Cqrs environment.
        /// </summary>
        ...
        public static void Configure(IEnvironmentConfiguration source)
        {
            ...
            Log.InfoFormat("Cqrs environment configured with {0} configuration source.", source.GetType().FullName);
        }
