...
{
    /// <summary>
    /// Occurs when a requested instance could not be found in the Cqrs environment configuration.
    /// </summary>
    [Serializable]
    public class InstanceNotFoundInEnvironmentConfigurationException : CqrsEnvironmentException
    {
        /// <summary>
        ...
        {
            return String.Format("Could not find requested type {0} in the CqrsEnvironment configuration. Make sure that " +
                                 "the CqrsEnvironment is configured correctly or that defaults are correctly set.", requestedType.FullName);
        }
    }
}
