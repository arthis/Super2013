...
namespace Cqrs.Commanding.CommandExecution.Mapping
{
    /// <summary>
    ...
    public class CommandMappingException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandMappingException"/> class with serialized data.
        /// </summary>
        ...
        protected CommandMappingException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
