...
namespace Cqrs.Commanding
{
    ...
    public abstract class CommandBase : ICommand
    {
        ...
        /// the <see cref="CqrsEnvironment"/>.
        /// </summary>
        /// <remarks>
        /// This uses the <see cref="CqrsEnvironment.Get{IUniqueIdentifierGenerator}"/> to get
        /// the generator to use to generate the command identifier.
        /// </remarks>
        protected CommandBase() : this(CqrsEnvironment.Get<IUniqueIdentifierGenerator>())
        {
            // Nothing.
        }
        ...
        {
            var knownCommandsEnumerator = CqrsEnvironment.Get<IKnownCommandsEnumerator>();
            if (knownCommandsEnumerator == null)
            {
                throw new InvalidOperationException("No Cqrs.Commanding.IKnownCommandsEnumerator implementation registered with the CqrsEnvironment.");
            }
