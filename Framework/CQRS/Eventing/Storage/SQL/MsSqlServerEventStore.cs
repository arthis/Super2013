...
using Cqrs.Eventing.Storage.Serialization;
using Newtonsoft.Json.Linq;

namespace Cqrs.Eventing.Storage.SQL
{
    /// <summary>
    ...
    public class MsSqlServerEventStore : IEventStore, ISnapshotStore
    {
        ...
        public static IEnumerable<String> GetTableCreationQueries()
        {
            ...
            const string resourcename = "Cqrs.Eventing.Storage.SQL.TableCreationScript.sql";
