...
{
    /// <summary>
    /// The base for all event messages. All sourced events should subclass from <see cref="Cqrs.Eventing.Sourcing.ISourcedEvent"/>.
    /// </summary>
    [Serializable]
    public abstract class Event : IEvent
    {
        ...
        public Event()
        {
            var idGenerator = CqrsEnvironment.Get<IUniqueIdentifierGenerator>();
            var clock = CqrsEnvironment.Get<IClock>();
