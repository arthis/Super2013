...
namespace Super.Programmazione.Events.Builders.Scenario
{
    public class SchedulazioneRotManAddedToScenarioBuilder : IEventBuilder<SchedulazioneRotManAddedToScenario>
    {
        ...
        public SchedulazioneRotManAddedToScenarioBuilder ForProgramma(Guid idProgramma)
        {
        ...
        public SchedulazioneRotManAddedToScenarioBuilder ForSchedulazione(Guid idScenario)
        {
            _idSchedulazione = idScenario;
            return this;
        }
