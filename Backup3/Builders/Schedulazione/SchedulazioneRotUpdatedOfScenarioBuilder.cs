...
{
    public class SchedulazioneRotUpdatedOfScenarioBuilder : IEventBuilder<SchedulazioneRotUpdatedOfScenario>
    {
        ...
        public SchedulazioneRotUpdatedOfScenarioBuilder ForPeriod(Period period)
        {
            _period = period;
            return this;
        }
